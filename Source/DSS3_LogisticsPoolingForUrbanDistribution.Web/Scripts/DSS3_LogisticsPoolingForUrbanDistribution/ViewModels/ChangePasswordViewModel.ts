...
namespace DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.ChangePassword {
export class ChangePasswordViewModel extends DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.MasterPage.MasterPageViewModel {
    public constructor() {
        super();
