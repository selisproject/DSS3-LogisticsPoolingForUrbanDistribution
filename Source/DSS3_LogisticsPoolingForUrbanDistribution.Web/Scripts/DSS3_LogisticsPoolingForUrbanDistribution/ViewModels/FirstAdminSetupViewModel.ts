...
namespace DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.FirstAdminSetup {
export class FirstAdminSetupViewModel extends DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.MasterPage.MasterPageViewModel {
    public constructor() {
        super();
