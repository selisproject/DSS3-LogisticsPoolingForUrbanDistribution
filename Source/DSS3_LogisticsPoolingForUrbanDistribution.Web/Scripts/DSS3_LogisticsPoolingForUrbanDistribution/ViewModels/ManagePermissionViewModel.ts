...
namespace DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.ManagePermission {
export class ManagePermissionViewModel extends DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.MasterPageForSlide.MasterPageForSlideViewModel {
    public constructor() {
        super();
