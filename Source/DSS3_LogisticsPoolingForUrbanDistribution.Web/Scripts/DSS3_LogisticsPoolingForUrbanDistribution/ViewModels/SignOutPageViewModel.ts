...
namespace DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.SignOutPage {
export class SignOutPageViewModel extends DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.MasterPage.MasterPageViewModel {
    public constructor() {
        super();
