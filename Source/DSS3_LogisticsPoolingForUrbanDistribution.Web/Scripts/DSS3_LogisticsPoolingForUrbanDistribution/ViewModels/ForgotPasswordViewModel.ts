...
namespace DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.ForgotPassword {
export class ForgotPasswordViewModel extends DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.MasterPage.MasterPageViewModel {
    public constructor() {
        super();
