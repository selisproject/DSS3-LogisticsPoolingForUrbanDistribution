...
namespace DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.ManageUser {
export class ManageUserViewModel extends DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.MasterPageForSlide.MasterPageForSlideViewModel {
    public constructor() {
        super();
