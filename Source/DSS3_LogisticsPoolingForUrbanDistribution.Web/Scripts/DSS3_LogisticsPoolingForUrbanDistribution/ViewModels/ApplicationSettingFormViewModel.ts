...
namespace DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.ApplicationSettingForm {
export class ApplicationSettingFormViewModel extends DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.MasterPageForSlide.MasterPageForSlideViewModel {
    public constructor() {
        super();
