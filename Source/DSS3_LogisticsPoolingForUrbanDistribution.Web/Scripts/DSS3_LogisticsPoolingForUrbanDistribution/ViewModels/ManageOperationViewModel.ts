...
namespace DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.ManageOperation {
export class ManageOperationViewModel extends DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.MasterPageForSlide.MasterPageForSlideViewModel {
    public constructor() {
        super();
