...
namespace DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.UserPreferences {
export class UserPreferencesViewModel extends DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.MasterPage.MasterPageViewModel {
    public constructor() {
        super();
