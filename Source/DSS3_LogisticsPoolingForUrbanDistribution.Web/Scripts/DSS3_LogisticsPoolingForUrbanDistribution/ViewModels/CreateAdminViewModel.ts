...
namespace DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.CreateAdmin {
export class CreateAdminViewModel extends DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.MasterPageSignIn.MasterPageSignInViewModel {
    public constructor() {
        super();
