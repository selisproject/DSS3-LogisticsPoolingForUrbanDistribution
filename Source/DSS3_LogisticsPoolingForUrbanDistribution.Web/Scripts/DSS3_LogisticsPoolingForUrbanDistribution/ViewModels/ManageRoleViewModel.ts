...
namespace DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.ManageRole {
export class ManageRoleViewModel extends DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.MasterPageForSlide.MasterPageForSlideViewModel {
    public constructor() {
        super();
