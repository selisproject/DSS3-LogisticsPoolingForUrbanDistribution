        ...
        var ApplicationSettingsListController = (function () {
            function ApplicationSettingsListController($scope, $timeout) {
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.ApplicationSettingsList.ApplicationSettingsListViewModel._initializeFrom($scope.model, context);
                };
