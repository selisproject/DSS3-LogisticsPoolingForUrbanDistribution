...
interface Window { scope_HomePage: DSS3_LogisticsPoolingForUrbanDistribution.Controllers.IHomePageScope; }
...
model:
    DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.HomePage.HomePageViewModel;
...
class HomePageController {
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.HomePage.HomePageViewModel._lightCast(window.scope_HomePage.model);
    ...
    constructor(private $scope: IHomePageScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.HomePage.HomePageViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IHomePageScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.HomePage.HomePageViewModel._initializeFrom(window.viewDTO.Model);
