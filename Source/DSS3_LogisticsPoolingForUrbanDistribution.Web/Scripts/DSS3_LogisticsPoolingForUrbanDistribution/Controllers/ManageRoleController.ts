...
interface Window { scope_ManageRole: DSS3_LogisticsPoolingForUrbanDistribution.Controllers.IManageRoleScope; }
...
model:
    DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.ManageRole.ManageRoleViewModel;
...
private timeoutDelayLockButton3Clicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.ManageRole.ManageRoleViewModel._lightCast(window.scope_ManageRole.model);
    ...
    constructor(private $scope: IManageRoleScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.ManageRole.ManageRoleViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IManageRoleScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.ManageRole.ManageRoleViewModel._initializeFrom(window.viewDTO.Model);
