...
interface Window { scope_ErrorPage: DSS3_LogisticsPoolingForUrbanDistribution.Controllers.IErrorPageScope; }
...
model:
    DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.ErrorPage.ErrorPageViewModel;
...
private timeoutDelayLockButtonClicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.ErrorPage.ErrorPageViewModel._lightCast(window.scope_ErrorPage.model);
    ...
    constructor(private $scope: IErrorPageScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.ErrorPage.ErrorPageViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IErrorPageScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.ErrorPage.ErrorPageViewModel._initializeFrom(window.viewDTO.Model);
