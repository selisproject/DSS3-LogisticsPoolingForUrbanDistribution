...
interface Window { scope_MasterPage: DSS3_LogisticsPoolingForUrbanDistribution.Controllers.IMasterPageScope; }
...
private timeoutDelayLockMasterSignInMenuItemPressed:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        //
        DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.MasterPage.MasterPageViewModel._lightCast(window.scope_MasterPage.model);
    ...
    constructor(private $scope: IMasterPageScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.MasterPage.MasterPageViewModel._initializeFrom($scope.model, context);
