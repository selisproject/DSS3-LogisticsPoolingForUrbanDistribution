...
interface Window { scope_PermissionsList: DSS3_LogisticsPoolingForUrbanDistribution.Controllers.IPermissionsListScope; }
...
model:
    DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.PermissionsList.PermissionsListViewModel;
...
private timeoutDelayLockEditClicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.PermissionsList.PermissionsListViewModel._lightCast(window.scope_PermissionsList.model);
    ...
    constructor(private $scope: IPermissionsListScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.PermissionsList.PermissionsListViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IPermissionsListScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.PermissionsList.PermissionsListViewModel._initializeFrom(window.viewDTO.Model);
