...
interface Window { scope_ChangePassword: DSS3_LogisticsPoolingForUrbanDistribution.Controllers.IChangePasswordScope; }
...
model:
    DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.ChangePassword.ChangePasswordViewModel;
...
private timeoutDelayLockButton11Clicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.ChangePassword.ChangePasswordViewModel._lightCast(window.scope_ChangePassword.model);
    ...
    constructor(private $scope: IChangePasswordScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.ChangePassword.ChangePasswordViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IChangePasswordScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.ChangePassword.ChangePasswordViewModel._initializeFrom(window.viewDTO.Model);
