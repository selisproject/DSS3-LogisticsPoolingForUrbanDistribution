...
interface Window { scope_RolesList: DSS3_LogisticsPoolingForUrbanDistribution.Controllers.IRolesListScope; }
...
model:
    DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.RolesList.RolesListViewModel;
...
private timeoutDelayLockEditClicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.RolesList.RolesListViewModel._lightCast(window.scope_RolesList.model);
    ...
    constructor(private $scope: IRolesListScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.RolesList.RolesListViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IRolesListScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.RolesList.RolesListViewModel._initializeFrom(window.viewDTO.Model);
