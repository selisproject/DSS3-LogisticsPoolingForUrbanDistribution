...
interface Window { scope_NotFoundPage: DSS3_LogisticsPoolingForUrbanDistribution.Controllers.INotFoundPageScope; }
...
model:
    DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.NotFoundPage.NotFoundPageViewModel;
...
private timeoutDelayLockButtonClicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.NotFoundPage.NotFoundPageViewModel._lightCast(window.scope_NotFoundPage.model);
    ...
    constructor(private $scope: INotFoundPageScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.NotFoundPage.NotFoundPageViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: INotFoundPageScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.NotFoundPage.NotFoundPageViewModel._initializeFrom(window.viewDTO.Model);
