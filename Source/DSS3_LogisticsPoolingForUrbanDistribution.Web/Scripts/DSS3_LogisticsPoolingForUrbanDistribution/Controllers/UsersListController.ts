...
interface Window { scope_UsersList: DSS3_LogisticsPoolingForUrbanDistribution.Controllers.IUsersListScope; }
...
model:
    DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.UsersList.UsersListViewModel;
...
private timeoutDelayLockEditClicked:
    ...
    constructor(private $scope: IUsersListScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.UsersList.UsersListViewModel._initializeFrom($scope.model, context);
