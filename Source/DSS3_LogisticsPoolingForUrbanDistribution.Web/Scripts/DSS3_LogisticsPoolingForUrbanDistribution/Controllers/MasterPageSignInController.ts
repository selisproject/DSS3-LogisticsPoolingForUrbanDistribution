...
interface Window { scope_MasterPageSignIn: DSS3_LogisticsPoolingForUrbanDistribution.Controllers.IMasterPageSignInScope; }
...
class MasterPageSignInController {
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        //
        DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.MasterPageSignIn.MasterPageSignInViewModel._lightCast(window.scope_MasterPageSignIn.model);
    ...
    constructor(private $scope: IMasterPageSignInScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.MasterPageSignIn.MasterPageSignInViewModel._initializeFrom($scope.model, context);
