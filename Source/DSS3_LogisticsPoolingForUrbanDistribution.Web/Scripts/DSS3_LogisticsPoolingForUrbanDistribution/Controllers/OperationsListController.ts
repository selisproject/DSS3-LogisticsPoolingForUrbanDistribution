...
interface Window { scope_OperationsList: DSS3_LogisticsPoolingForUrbanDistribution.Controllers.IOperationsListScope; }
...
model:
    DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.OperationsList.OperationsListViewModel;
...
private timeoutDelayLockEditClicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.OperationsList.OperationsListViewModel._lightCast(window.scope_OperationsList.model);
    ...
    constructor(private $scope: IOperationsListScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.OperationsList.OperationsListViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IOperationsListScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.OperationsList.OperationsListViewModel._initializeFrom(window.viewDTO.Model);
