...
interface Window { scope_ManagePermission: DSS3_LogisticsPoolingForUrbanDistribution.Controllers.IManagePermissionScope; }
...
model:
    DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.ManagePermission.ManagePermissionViewModel;
...
private timeoutDelayLockButton3Clicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.ManagePermission.ManagePermissionViewModel._lightCast(window.scope_ManagePermission.model);
    ...
    constructor(private $scope: IManagePermissionScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.ManagePermission.ManagePermissionViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IManagePermissionScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.ManagePermission.ManagePermissionViewModel._initializeFrom(window.viewDTO.Model);
