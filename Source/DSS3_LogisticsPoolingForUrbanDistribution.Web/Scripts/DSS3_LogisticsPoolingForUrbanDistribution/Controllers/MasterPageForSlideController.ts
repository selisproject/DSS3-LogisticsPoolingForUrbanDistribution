...
interface Window { scope_MasterPageForSlide: DSS3_LogisticsPoolingForUrbanDistribution.Controllers.IMasterPageForSlideScope; }
...
class MasterPageForSlideController {
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        //
        DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.MasterPageForSlide.MasterPageForSlideViewModel._lightCast(window.scope_MasterPageForSlide.model);
    ...
    constructor(private $scope: IMasterPageForSlideScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.MasterPageForSlide.MasterPageForSlideViewModel._initializeFrom($scope.model, context);
