...
interface Window { scope_ApplicationSettingsList: DSS3_LogisticsPoolingForUrbanDistribution.Controllers.IApplicationSettingsListScope; }
...
model:
    DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.ApplicationSettingsList.ApplicationSettingsListViewModel;
...
private timeoutDelayLockEditClicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.ApplicationSettingsList.ApplicationSettingsListViewModel._lightCast(window.scope_ApplicationSettingsList.model);
    ...
    constructor(private $scope: IApplicationSettingsListScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.ApplicationSettingsList.ApplicationSettingsListViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IApplicationSettingsListScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.ApplicationSettingsList.ApplicationSettingsListViewModel._initializeFrom(window.viewDTO.Model);
