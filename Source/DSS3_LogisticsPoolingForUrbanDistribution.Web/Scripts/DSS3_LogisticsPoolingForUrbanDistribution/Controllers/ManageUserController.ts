...
interface Window { scope_ManageUser: DSS3_LogisticsPoolingForUrbanDistribution.Controllers.IManageUserScope; }
...
model:
    DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.ManageUser.ManageUserViewModel;
...
private timeoutDelayLockExitBtnClicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.ManageUser.ManageUserViewModel._lightCast(window.scope_ManageUser.model);
    ...
    constructor(private $scope: IManageUserScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.ManageUser.ManageUserViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IManageUserScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.ManageUser.ManageUserViewModel._initializeFrom(window.viewDTO.Model);
