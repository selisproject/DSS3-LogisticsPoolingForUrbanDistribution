...
interface Window { scope_ForgotPassword: DSS3_LogisticsPoolingForUrbanDistribution.Controllers.IForgotPasswordScope; }
...
model:
    DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.ForgotPassword.ForgotPasswordViewModel;
...
private timeoutDelayLockButton11Clicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.ForgotPassword.ForgotPasswordViewModel._lightCast(window.scope_ForgotPassword.model);
    ...
    constructor(private $scope: IForgotPasswordScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.ForgotPassword.ForgotPasswordViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IForgotPasswordScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.ForgotPassword.ForgotPasswordViewModel._initializeFrom(window.viewDTO.Model);
