...
interface Window { scope_UserPreferences: DSS3_LogisticsPoolingForUrbanDistribution.Controllers.IUserPreferencesScope; }
...
model:
    DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.UserPreferences.UserPreferencesViewModel;
...
private timeoutDelayLockCancelBtnClicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.UserPreferences.UserPreferencesViewModel._lightCast(window.scope_UserPreferences.model);
    ...
    constructor(private $scope: IUserPreferencesScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.UserPreferences.UserPreferencesViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IUserPreferencesScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DSS3_LogisticsPoolingForUrbanDistribution.ViewModels.UserPreferences.UserPreferencesViewModel._initializeFrom(window.viewDTO.Model);
