...
using DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ApplicationSettingForm;
...
namespace DSS3_LogisticsPoolingForUrbanDistribution.UI.Controllers.ApplicationSettingForm
{
    ...
    public class ApplicationSettingFormController : ControllerBase<ApplicationSettingFormViewModel, ApplicationSettingFormViewModelDTO>
    {
        ...
        public ActionResult ExecuteEditApplicationSetting(int? Id)
        {
            ...
            ((MasterPageForSlide.MasterPageForSlideController) _parentController).ExecuteRender();
            ActionResult _result = null;
            @model.ApplicationSetting =  new DSS3_LogisticsPoolingForUrbanDistribution.DAL.Repository().GetById<zAppDev.DotNet.Framework.Identity.Model.ApplicationSetting>(Id);
        ...
        {
            ActionResult _result = null;
            new DSS3_LogisticsPoolingForUrbanDistribution.DAL.Repository().Save<zAppDev.DotNet.Framework.Identity.Model.ApplicationSetting>(@model.ApplicationSetting);
            _result = CloseForm();
            return _result;
        }
        ...
        {
            ActionResult _result = null;
            new DSS3_LogisticsPoolingForUrbanDistribution.DAL.Repository().DeleteApplicationSetting(@model.ApplicationSetting);
            _result = CloseForm();
            return _result;
        }
        #endregion
