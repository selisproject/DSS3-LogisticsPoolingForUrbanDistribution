...
using DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.FirstAdminSetup;
...
namespace DSS3_LogisticsPoolingForUrbanDistribution.UI.Controllers.FirstAdminSetup
{
    ...
    public class FirstAdminSetupController : ControllerBase<FirstAdminSetupViewModel, FirstAdminSetupViewModelDTO>
    {
        ...
        public ActionResult ExecuteRender()
        {
            ...
            if ((new DSS3_LogisticsPoolingForUrbanDistribution.DAL.Repository().GetAsQueryable<zAppDev.DotNet.Framework.Identity.Model.ApplicationUser>()?.Any((x) => x.Roles.Any((r) => r.Name == "Administrator")) ?? false))
            {
                ClientCommand(ClientCommands.SHOW_MESSAGE, BaseViewPage<string>.GetResourceValue("FirstAdminSetup", "RES_CUSTOM_NoAccess").ToString(), MessageType.Error, (!string.IsNullOrEmpty(System.Configuration.ConfigurationManager.AppSettings["ServerExternalPath"]) ?
                              ...
                              "/HomePage/Render");
                zAppDev.DotNet.Framework.Utilities.DebugHelper.Log(zAppDev.DotNet.Framework.Utilities.DebugMessageType.Warning, "FirstAdminSetup",  DSS3_LogisticsPoolingForUrbanDistribution.Hubs.EventsHub.RaiseDebugMessage, "Admin user already exists");
                return null;
            }
        ...
        {
            ActionResult _result = null;
            zAppDev.DotNet.Framework.Identity.Model.ApplicationRole role = new DSS3_LogisticsPoolingForUrbanDistribution.DAL.Repository().GetAsQueryable<zAppDev.DotNet.Framework.Identity.Model.ApplicationRole>((r) => r.Name == "Administrator")?.FirstOrDefault();
            if (role == null)
            {
            ...
            new DSS3_LogisticsPoolingForUrbanDistribution.DAL.Repository().Save<zAppDev.DotNet.Framework.Identity.Model.ApplicationUser>(@model.ApplicationUser);
