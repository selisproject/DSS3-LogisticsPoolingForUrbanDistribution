...
using DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ErrorPage;
...
namespace DSS3_LogisticsPoolingForUrbanDistribution.UI.Controllers.ErrorPage
{
    ...
    public class ErrorPageController : ControllerBase<ErrorPageViewModel, ErrorPageViewModelDTO>
    {
        ...
        public ActionResult ExecuteSendErrorToAdministrator()
        {
            ...
            mail.Subject = "DSS3_LogisticsPoolingForUrbanDistribution" + " threw an Exception";
