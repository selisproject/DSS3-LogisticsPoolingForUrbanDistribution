...
using DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ApplicationSettingsList;
...
namespace DSS3_LogisticsPoolingForUrbanDistribution.UI.Controllers.ApplicationSettingsList
{
    ...
    public class ApplicationSettingsListController : ControllerBase<ApplicationSettingsListViewModel, ApplicationSettingsListViewModelDTO>
    {
        ...
        {
            __request = __request ?? new DatasourceRequest(0, int.MaxValue);
            var __items = new DSS3_LogisticsPoolingForUrbanDistribution.DAL.Repository().GetAsQueryable<zAppDev.DotNet.Framework.Identity.Model.ApplicationSetting>().AsQueryable();
            return __items;
        }
