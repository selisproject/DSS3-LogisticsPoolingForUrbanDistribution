...
using DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ManageUser;
...
namespace DSS3_LogisticsPoolingForUrbanDistribution.UI.Controllers.ManageUser
{
    ...
    public class ManageUserController : ControllerBase<ManageUserViewModel, ManageUserViewModelDTO>
    {
        ...
        public ActionResult ExecuteEditUser(string Id)
        {
            ...
            ((MasterPageForSlide.MasterPageForSlideController) _parentController).ExecuteRender();
            ActionResult _result = null;
            @model.ApplicationUser =  new DSS3_LogisticsPoolingForUrbanDistribution.DAL.Repository().GetById<zAppDev.DotNet.Framework.Identity.Model.ApplicationUser>(Id);
        ...
        {
            ActionResult _result = null;
            new DSS3_LogisticsPoolingForUrbanDistribution.DAL.Repository().DeleteApplicationUser(@model.ApplicationUser);
            _result = CloseForm();
            return _result;
        }
