...
using DSS3_LogisticsPoolingForUrbanDistribution.UI.Controllers.ManageOperation;
using AppCode;
...
namespace DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ManageOperation
{
    ...
    [OriginalType(typeof(DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ManageOperation.ManageOperationViewModel))]
    public class ManageOperationViewModelDTO : MasterPageForSlideViewModelDTO, IViewModelDTO<DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ManageOperation.ManageOperationViewModel>
    {

        [JsonConstructor]
        public ManageOperationViewModelDTO() { }
        public ManageOperationViewModelDTO(DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ManageOperation.ManageOperationViewModel original, bool parentIsDirty = false)  : base(original)
        {
        ...
        public override string _originalTypeClassName => typeof(DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ManageOperation.ManageOperationViewModel).FullName;
        public List<SelectedItemInfo<int?>> Button2SelectedItemKeys;

        public new DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ManageOperation.ManageOperationViewModel GetModel()
        {
            var alreadySeenInstance = DTOHelper.GetSeenModelInstance<DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ManageOperation.ManageOperationViewModel>(_clientKey, _originalTypeClassName, _baseClasses);
            if (alreadySeenInstance != null) return alreadySeenInstance;
            return new DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ManageOperation.ManageOperationViewModel();
        }
        new  public DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ManageOperation.ManageOperationViewModel Convert()
        {
            var original = GetModel();
            if (original == null)
            {
                original = new DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ManageOperation.ManageOperationViewModel();
            }
            DTOHelper.UpdateSeenModelInstances(this, original);
            Hydrate(original);
            return original;
        }
        public void Hydrate(DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ManageOperation.ManageOperationViewModel original)
        {
            if (original == null) return;
