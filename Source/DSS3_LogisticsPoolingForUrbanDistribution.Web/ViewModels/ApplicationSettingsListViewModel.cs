...
using DSS3_LogisticsPoolingForUrbanDistribution.UI.Controllers.ApplicationSettingsList;
using AppCode;
...
namespace DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ApplicationSettingsList
{
    ...
    [OriginalType(typeof(DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ApplicationSettingsList.ApplicationSettingsListViewModel))]
    public class ApplicationSettingsListViewModelDTO : MasterPageViewModelDTO, IViewModelDTO<DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ApplicationSettingsList.ApplicationSettingsListViewModel>
    {

        [JsonConstructor]
        public ApplicationSettingsListViewModelDTO() { }
        public ApplicationSettingsListViewModelDTO(DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ApplicationSettingsList.ApplicationSettingsListViewModel original, bool parentIsDirty = false)  : base(original)
        {
        ...
        public override string _originalTypeClassName => typeof(DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ApplicationSettingsList.ApplicationSettingsListViewModel).FullName;
        public List<SelectedItemInfo<int?>> ListSelectedItemKeys;

        public new DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ApplicationSettingsList.ApplicationSettingsListViewModel GetModel()
        {
            var alreadySeenInstance = DTOHelper.GetSeenModelInstance<DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ApplicationSettingsList.ApplicationSettingsListViewModel>(_clientKey, _originalTypeClassName, _baseClasses);
            if (alreadySeenInstance != null) return alreadySeenInstance;
            return new DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ApplicationSettingsList.ApplicationSettingsListViewModel();
        }
        new  public DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ApplicationSettingsList.ApplicationSettingsListViewModel Convert()
        {
            var original = GetModel();
            if (original == null)
            {
                original = new DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ApplicationSettingsList.ApplicationSettingsListViewModel();
            }
            DTOHelper.UpdateSeenModelInstances(this, original);
            Hydrate(original);
            return original;
        }
        public void Hydrate(DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ApplicationSettingsList.ApplicationSettingsListViewModel original)
        {
            if (original == null) return;
