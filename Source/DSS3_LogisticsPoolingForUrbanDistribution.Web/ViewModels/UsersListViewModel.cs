...
using DSS3_LogisticsPoolingForUrbanDistribution.UI.Controllers.UsersList;
using AppCode;
...
namespace DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.UsersList
{
    ...
    [OriginalType(typeof(DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.UsersList.UsersListViewModel))]
    public class UsersListViewModelDTO : MasterPageViewModelDTO, IViewModelDTO<DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.UsersList.UsersListViewModel>
    {

        [JsonConstructor]
        public UsersListViewModelDTO() { }
        public UsersListViewModelDTO(DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.UsersList.UsersListViewModel original, bool parentIsDirty = false)  : base(original)
        {
        ...
        public override string _originalTypeClassName => typeof(DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.UsersList.UsersListViewModel).FullName;
        public List<SelectedItemInfo<string>> ListSelectedItemKeys;

        public new DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.UsersList.UsersListViewModel GetModel()
        {
            var alreadySeenInstance = DTOHelper.GetSeenModelInstance<DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.UsersList.UsersListViewModel>(_clientKey, _originalTypeClassName, _baseClasses);
            if (alreadySeenInstance != null) return alreadySeenInstance;
            return new DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.UsersList.UsersListViewModel();
        }
        new  public DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.UsersList.UsersListViewModel Convert()
        {
            var original = GetModel();
            if (original == null)
            {
                original = new DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.UsersList.UsersListViewModel();
            }
            DTOHelper.UpdateSeenModelInstances(this, original);
            Hydrate(original);
            return original;
        }
        public void Hydrate(DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.UsersList.UsersListViewModel original)
        {
            if (original == null) return;
