...
using DSS3_LogisticsPoolingForUrbanDistribution.UI.Controllers.ManageUser;
using AppCode;
...
namespace DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ManageUser
{
    ...
    [OriginalType(typeof(DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ManageUser.ManageUserViewModel))]
    public class ManageUserViewModelDTO : MasterPageForSlideViewModelDTO, IViewModelDTO<DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ManageUser.ManageUserViewModel>
    {

        [JsonConstructor]
        public ManageUserViewModelDTO() { }
        public ManageUserViewModelDTO(DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ManageUser.ManageUserViewModel original, bool parentIsDirty = false)  : base(original)
        {
        ...
        public override string _originalTypeClassName => typeof(DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ManageUser.ManageUserViewModel).FullName;
        public List<SelectedItemInfo<int?>> Button1SelectedItemKeys;
        public List<SelectedItemInfo<int?>> Button2SelectedItemKeys;

        public new DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ManageUser.ManageUserViewModel GetModel()
        {
            var alreadySeenInstance = DTOHelper.GetSeenModelInstance<DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ManageUser.ManageUserViewModel>(_clientKey, _originalTypeClassName, _baseClasses);
            if (alreadySeenInstance != null) return alreadySeenInstance;
            return new DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ManageUser.ManageUserViewModel();
        }
        new  public DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ManageUser.ManageUserViewModel Convert()
        {
            var original = GetModel();
            if (original == null)
            {
                original = new DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ManageUser.ManageUserViewModel();
            }
            DTOHelper.UpdateSeenModelInstances(this, original);
            Hydrate(original);
            return original;
        }
        public void Hydrate(DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ManageUser.ManageUserViewModel original)
        {
            if (original == null) return;
