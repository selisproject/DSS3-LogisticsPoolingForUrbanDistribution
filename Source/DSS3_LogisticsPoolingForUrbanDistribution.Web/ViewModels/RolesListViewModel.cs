...
using DSS3_LogisticsPoolingForUrbanDistribution.UI.Controllers.RolesList;
using AppCode;
...
namespace DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.RolesList
{
    ...
    [OriginalType(typeof(DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.RolesList.RolesListViewModel))]
    public class RolesListViewModelDTO : MasterPageViewModelDTO, IViewModelDTO<DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.RolesList.RolesListViewModel>
    {

        [JsonConstructor]
        public RolesListViewModelDTO() { }
        public RolesListViewModelDTO(DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.RolesList.RolesListViewModel original, bool parentIsDirty = false)  : base(original)
        {
        ...
        public override string _originalTypeClassName => typeof(DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.RolesList.RolesListViewModel).FullName;
        public List<SelectedItemInfo<int?>> ListSelectedItemKeys;

        public new DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.RolesList.RolesListViewModel GetModel()
        {
            var alreadySeenInstance = DTOHelper.GetSeenModelInstance<DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.RolesList.RolesListViewModel>(_clientKey, _originalTypeClassName, _baseClasses);
            if (alreadySeenInstance != null) return alreadySeenInstance;
            return new DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.RolesList.RolesListViewModel();
        }
        new  public DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.RolesList.RolesListViewModel Convert()
        {
            var original = GetModel();
            if (original == null)
            {
                original = new DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.RolesList.RolesListViewModel();
            }
            DTOHelper.UpdateSeenModelInstances(this, original);
            Hydrate(original);
            return original;
        }
        public void Hydrate(DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.RolesList.RolesListViewModel original)
        {
            if (original == null) return;
