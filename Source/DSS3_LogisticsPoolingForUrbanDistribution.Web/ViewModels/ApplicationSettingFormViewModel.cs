...
using DSS3_LogisticsPoolingForUrbanDistribution.UI.Controllers.ApplicationSettingForm;
using AppCode;
...
using DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.MasterPageForSlide;
using DSS3_LogisticsPoolingForUrbanDistribution.UI.Controllers.MasterPageForSlide;
namespace DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ApplicationSettingForm
{
    ...
    [OriginalType(typeof(DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ApplicationSettingForm.ApplicationSettingFormViewModel))]
    public class ApplicationSettingFormViewModelDTO : MasterPageForSlideViewModelDTO, IViewModelDTO<DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ApplicationSettingForm.ApplicationSettingFormViewModel>
    {

        [JsonConstructor]
        public ApplicationSettingFormViewModelDTO() { }
        public ApplicationSettingFormViewModelDTO(DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ApplicationSettingForm.ApplicationSettingFormViewModel original, bool parentIsDirty = false)  : base(original)
        {
        ...
        public override string _originalTypeClassName => typeof(DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ApplicationSettingForm.ApplicationSettingFormViewModel).FullName;

        public new DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ApplicationSettingForm.ApplicationSettingFormViewModel GetModel()
        {
            var alreadySeenInstance = DTOHelper.GetSeenModelInstance<DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ApplicationSettingForm.ApplicationSettingFormViewModel>(_clientKey, _originalTypeClassName, _baseClasses);
            if (alreadySeenInstance != null) return alreadySeenInstance;
            return new DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ApplicationSettingForm.ApplicationSettingFormViewModel();
        }
        new  public DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ApplicationSettingForm.ApplicationSettingFormViewModel Convert()
        {
            var original = GetModel();
            if (original == null)
            {
                original = new DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ApplicationSettingForm.ApplicationSettingFormViewModel();
            }
            DTOHelper.UpdateSeenModelInstances(this, original);
            Hydrate(original);
            return original;
        }
        public void Hydrate(DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ApplicationSettingForm.ApplicationSettingFormViewModel original)
        {
            if (original == null) return;
