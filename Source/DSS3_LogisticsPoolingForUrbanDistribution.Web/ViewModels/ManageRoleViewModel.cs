...
using DSS3_LogisticsPoolingForUrbanDistribution.UI.Controllers.ManageRole;
using AppCode;
...
namespace DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ManageRole
{
    ...
    [OriginalType(typeof(DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ManageRole.ManageRoleViewModel))]
    public class ManageRoleViewModelDTO : MasterPageForSlideViewModelDTO, IViewModelDTO<DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ManageRole.ManageRoleViewModel>
    {

        [JsonConstructor]
        public ManageRoleViewModelDTO() { }
        public ManageRoleViewModelDTO(DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ManageRole.ManageRoleViewModel original, bool parentIsDirty = false)  : base(original)
        {
        ...
        public override string _originalTypeClassName => typeof(DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ManageRole.ManageRoleViewModel).FullName;
        public List<SelectedItemInfo<int?>> AddPermissionSelectedItemKeys;

        public new DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ManageRole.ManageRoleViewModel GetModel()
        {
            var alreadySeenInstance = DTOHelper.GetSeenModelInstance<DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ManageRole.ManageRoleViewModel>(_clientKey, _originalTypeClassName, _baseClasses);
            if (alreadySeenInstance != null) return alreadySeenInstance;
            return new DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ManageRole.ManageRoleViewModel();
        }
        new  public DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ManageRole.ManageRoleViewModel Convert()
        {
            var original = GetModel();
            if (original == null)
            {
                original = new DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ManageRole.ManageRoleViewModel();
            }
            DTOHelper.UpdateSeenModelInstances(this, original);
            Hydrate(original);
            return original;
        }
        public void Hydrate(DSS3_LogisticsPoolingForUrbanDistribution.UI.ViewModels.ManageRole.ManageRoleViewModel original)
        {
            if (original == null) return;
