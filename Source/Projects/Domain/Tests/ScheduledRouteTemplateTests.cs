...
namespace DSS3_LogisticsPoolingForUrbanDistribution.BoTesting.Tests
{
    ...
    internal class ScheduledRouteTemplateTests : NHibernateFixture
    {
        ...
        public void ScheduledRouteTemplate_filtering_test()
        {
            ...
            List<DSS3_LogisticsPoolingForUrbanDistribution.BO.ScheduledRouteTemplate> results = null;
            Assert.DoesNotThrow(() =>
            {
                results = repo.GetAsQueryable<DSS3_LogisticsPoolingForUrbanDistribution.BO.ScheduledRouteTemplate>(
                              a => true
