...
namespace DSS3_LogisticsPoolingForUrbanDistribution.BoTesting.Tests
{
    ...
    internal class RegionalAgentTests : NHibernateFixture
    {
        ...
        public void RegionalAgent_persistence_test()
        {
            ...
            {
                UserName = "0e46ff96-9929-408c-ae07-4b0f4fab86d5RegionalAgentUser_UserName",
        ...
        public void RegionalAgent_filtering_test()
        {
            ...
            List<DSS3_LogisticsPoolingForUrbanDistribution.BO.RegionalAgent> results = null;
            Assert.DoesNotThrow(() =>
            {
                results = repo.GetAsQueryable<DSS3_LogisticsPoolingForUrbanDistribution.BO.RegionalAgent>(
                              a => true
