...
namespace DSS3_LogisticsPoolingForUrbanDistribution.BoTesting.Tests
{
    ...
    internal class TblZslNormalisationSuggestionTests : NHibernateFixture
    {
        ...
        public void TblZslNormalisationSuggestion_persistence_test()
        {
            ...
            new PersistenceSpecification<DSS3_LogisticsPoolingForUrbanDistribution.BO.TblZslNormalisationSuggestion>(Session)
            ...
            .CheckProperty(p => p.Sender_Zipcode, 639)
            ...
            .CheckProperty(p => p.Receiver_Zipcode, 2119)
            ...
            .CheckProperty(p => p.Weight, 5365)
            .CheckProperty(p => p.Volume, 6371)
            .CheckProperty(p => p.Cost, 1408)
            .CheckProperty(p => p.Currency, "TblZslNormalisationSuggestion_Currency")
            .CheckProperty(p => p.Number_Of_Pallets, 1923)
        ...
        public void TblZslNormalisationSuggestion_filtering_test()
        {
            ...
            List<DSS3_LogisticsPoolingForUrbanDistribution.BO.TblZslNormalisationSuggestion> results = null;
            Assert.DoesNotThrow(() =>
            {
                results = repo.GetAsQueryable<DSS3_LogisticsPoolingForUrbanDistribution.BO.TblZslNormalisationSuggestion>(
                              a => true
