...
namespace DSS3_LogisticsPoolingForUrbanDistribution.BoTesting.Tests
{
    ...
    internal class tblZslTransportDetailTests : NHibernateFixture
    {
        ...
        public void tblZslTransportDetail_persistence_test()
        {
            ...
            var _zanardobo_tblzslplatformbookingorder_tblzsltransportdetail = new DSS3_LogisticsPoolingForUrbanDistribution.BO.tblZslPlatformBookingOrder
            {
                BookingDate = now,
                ...
                DateExit = now,
                TImeExit = now,
                RouteTracking_ID = 1454,
            };
            var _zanardobo_tblzslcustomer_tblzsltransportdetail = new DSS3_LogisticsPoolingForUrbanDistribution.BO.tblZslCustomer
            {
                CustomerFullName = "tblZslCustomer_CustomerFullName",
            };
            var _zanardobo_tblzslworker_tblzsltransportdetail = new DSS3_LogisticsPoolingForUrbanDistribution.BO.tblZslWorker
            {
                WorkerFullName = "tblZslWorker_WorkerFullName",
            };
            new PersistenceSpecification<DSS3_LogisticsPoolingForUrbanDistribution.BO.tblZslTransportDetail>(Session)
            .CheckProperty(p => p.EventID, 1352)
        ...
        public void tblZslTransportDetail_filtering_test()
        {
            ...
            List<DSS3_LogisticsPoolingForUrbanDistribution.BO.tblZslTransportDetail> results = null;
            Assert.DoesNotThrow(() =>
            {
                results = repo.GetAsQueryable<DSS3_LogisticsPoolingForUrbanDistribution.BO.tblZslTransportDetail>(
                              a => true
                              && (a.EventID + 123 > 0)
                              && (a.Qty + 123 > 0)
