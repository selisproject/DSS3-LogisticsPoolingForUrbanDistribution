...
namespace DSS3_LogisticsPoolingForUrbanDistribution.BoTesting.Tests
{
    ...
    internal class tblZslTransportOrderTests : NHibernateFixture
    {
        ...
        public void tblZslTransportOrder_persistence_test()
        {
            ...
            var _zanardobo_transportorder_tblzsltransportorder = new DSS3_LogisticsPoolingForUrbanDistribution.BO.tblZslTransportOrder
            {
            ...
            var _zanardobo_tblzslcustomer_tblzsltransportorder = new DSS3_LogisticsPoolingForUrbanDistribution.BO.tblZslCustomer
            {
                CustomerFullName = "tblZslCustomer_CustomerFullName",
            };
            new PersistenceSpecification<DSS3_LogisticsPoolingForUrbanDistribution.BO.tblZslTransportOrder>(Session)
            .CheckProperty(p => p.TransportOrderNo, "tblZslTransportOrder_TransportOrderNo")
            .CheckProperty(p => p.OrderYear, 2863)
        ...
        public void tblZslTransportOrder_filtering_test()
        {
            ...
            List<DSS3_LogisticsPoolingForUrbanDistribution.BO.tblZslTransportOrder> results = null;
            Assert.DoesNotThrow(() =>
            {
                results = repo.GetAsQueryable<DSS3_LogisticsPoolingForUrbanDistribution.BO.tblZslTransportOrder>(
                              a => true
