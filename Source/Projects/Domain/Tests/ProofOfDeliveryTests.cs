...
namespace DSS3_LogisticsPoolingForUrbanDistribution.BoTesting.Tests
{
    ...
    internal class ProofOfDeliveryTests : NHibernateFixture
    {
        ...
        public void ProofOfDelivery_persistence_test()
        {
            ...
            {
                UserName = "ef49b312-d2f3-4ce4-9531-fcf11b607b79TruckDriver_UserName",
        ...
        public void ProofOfDelivery_filtering_test()
        {
            ...
            List<DSS3_LogisticsPoolingForUrbanDistribution.BO.ProofOfDelivery> results = null;
            Assert.DoesNotThrow(() =>
            {
                results = repo.GetAsQueryable<DSS3_LogisticsPoolingForUrbanDistribution.BO.ProofOfDelivery>(
                              a => true
