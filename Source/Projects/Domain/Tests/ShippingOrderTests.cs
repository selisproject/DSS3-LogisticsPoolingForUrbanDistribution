...
namespace DSS3_LogisticsPoolingForUrbanDistribution.BoTesting.Tests
{
    ...
    internal class ShippingOrderTests : NHibernateFixture
    {
        ...
        public void ShippingOrder_persistence_test()
        {
            ...
            var _actionsbo_shipment_shippingorders = new DSS3_LogisticsPoolingForUrbanDistribution.BO.Shipment
            {
            ...
            var _actionsbo_shipment_shippingorders2 = new DSS3_LogisticsPoolingForUrbanDistribution.BO.Shipment
            {
                Owner = "Shipment_Owner",
                DepartureTime = now,
                CurrentStatus = "Shipment_CurrentStatus",
            ...
            var _ordersbo_departurepoint_shippingorder = new DSS3_LogisticsPoolingForUrbanDistribution.BO.Location
            {
                Name = "Location_Name",
            ...
            var _ordersbo_arrivalpoint_shippingorder = new DSS3_LogisticsPoolingForUrbanDistribution.BO.Location
            {
                Name = "Location_Name",
                Street = "Location_Street",
                City = "Location_City",
            ...
            var _ordersbo_statusevolution_shippingorder = new DSS3_LogisticsPoolingForUrbanDistribution.BO.StatusEvolution
            {
                TimeChanged = now,
                Description = "StatusEvolution_Description",
            };
            var _ordersbo_statusevolution_shippingorder2 = new DSS3_LogisticsPoolingForUrbanDistribution.BO.StatusEvolution
            {
                TimeChanged = now,
                Description = "StatusEvolution_Description",
            };
            var _ordersbo_parent_shippingorder = new DSS3_LogisticsPoolingForUrbanDistribution.BO.ShippingOrder
            {
                DepartureDate = now,
                ArrivalDate = now,
            ...
            var _ordersbo_plannedvolume_shippingorder = new DSS3_LogisticsPoolingForUrbanDistribution.BO.CustomVolume
            {
                Weight = 222222.22M,
            };
            var _ordersbo_plannedvolume_shippingorder2 = new DSS3_LogisticsPoolingForUrbanDistribution.BO.CustomVolume
            {
                Weight = 222222.22M,
            };
            var _ordersbo_actualvolume_shippingorder = new DSS3_LogisticsPoolingForUrbanDistribution.BO.CustomVolume
            {
                Weight = 222222.22M,
            };
            var _ordersbo_actualvolume_shippingorder2 = new DSS3_LogisticsPoolingForUrbanDistribution.BO.CustomVolume
            {
                Weight = 222222.22M,
            };
            var _ordersbo_itemtype_shippingorder = new DSS3_LogisticsPoolingForUrbanDistribution.BO.ItemType
            {
                Description = "ItemType_Description",
                Temperature = 6695,
            };
            new PersistenceSpecification<DSS3_LogisticsPoolingForUrbanDistribution.BO.ShippingOrder>(Session)
            ...
            .CheckProperty(p => p.Priority, 5417)
            .CheckBag(p => p.Shipment, (new List<DSS3_LogisticsPoolingForUrbanDistribution.BO.Shipment>
            {
            ...
            .CheckBag(p => p.StatusEvolution, (new List<DSS3_LogisticsPoolingForUrbanDistribution.BO.StatusEvolution>
            {
            ...
            .CheckBag(p => p.PlannedVolume, (new List<DSS3_LogisticsPoolingForUrbanDistribution.BO.CustomVolume>
            {
                _ordersbo_plannedvolume_shippingorder,
                _ordersbo_plannedvolume_shippingorder2
            }))
            .CheckBag(p => p.ActualVolume, (new List<DSS3_LogisticsPoolingForUrbanDistribution.BO.CustomVolume>
            {
        ...
        public void ShippingOrder_filtering_test()
        {
            ...
            List<DSS3_LogisticsPoolingForUrbanDistribution.BO.ShippingOrder> results = null;
            Assert.DoesNotThrow(() =>
            {
                results = repo.GetAsQueryable<DSS3_LogisticsPoolingForUrbanDistribution.BO.ShippingOrder>(
                              a => true
