...
namespace DSS3_LogisticsPoolingForUrbanDistribution.BoTesting.Tests
{
    ...
    internal class ScheduledRouteTests : NHibernateFixture
    {
        ...
        public void ScheduledRoute_filtering_test()
        {
            ...
            List<DSS3_LogisticsPoolingForUrbanDistribution.BO.ScheduledRoute> results = null;
            Assert.DoesNotThrow(() =>
            {
                results = repo.GetAsQueryable<DSS3_LogisticsPoolingForUrbanDistribution.BO.ScheduledRoute>(
                              a => true
                              ...
                              && a.TypeOfGoods == DSS3_LogisticsPoolingForUrbanDistribution.BO.TruckContent.Frozen
                              && (a.Revision + 123 > 0)
                              && (a.GUID != string.Empty && a.GUID != null)
                              && (a.ReservedCapacityLaden + 123 > 0)
                              && a.State == DSS3_LogisticsPoolingForUrbanDistribution.BO.ScheduledRouteState.UnderNegotiation
                              && (a.BaseId + 123 > 0)
                              && a.Frequency == DSS3_LogisticsPoolingForUrbanDistribution.BO.RouteFrequency.Weekly
                              ...
                              && a.Attribute == DSS3_LogisticsPoolingForUrbanDistribution.BO.ScheduledRouteState.UnderNegotiation
                              && a.WorkContract != null
                              ,
                              cacheQuery: true)
                          .OrderBy(a => a)
