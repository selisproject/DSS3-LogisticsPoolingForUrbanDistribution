...
namespace DSS3_LogisticsPoolingForUrbanDistribution.BoTesting.Tests
{
    ...
    internal class VehiculeTests : NHibernateFixture
    {
        ...
        public void Vehicule_filtering_test()
        {
            ...
            List<DSS3_LogisticsPoolingForUrbanDistribution.BO.Vehicule> results = null;
            Assert.DoesNotThrow(() =>
            {
                results = repo.GetAsQueryable<DSS3_LogisticsPoolingForUrbanDistribution.BO.Vehicule>(
                              a => true
