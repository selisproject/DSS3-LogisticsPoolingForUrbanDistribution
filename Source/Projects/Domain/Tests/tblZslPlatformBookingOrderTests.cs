...
namespace DSS3_LogisticsPoolingForUrbanDistribution.BoTesting.Tests
{
    ...
    internal class tblZslPlatformBookingOrderTests : NHibernateFixture
    {
        ...
        public void tblZslPlatformBookingOrder_persistence_test()
        {
            ...
            var _zanardobo_platformbookingorder_tblzslplatformbookingorder = new DSS3_LogisticsPoolingForUrbanDistribution.BO.tblZslPlatformBookingOrder
            {
                BookingDate = now,
                ...
                DateExit = now,
                TImeExit = now,
                RouteTracking_ID = 2948,
            };
            var _zanardobo_tblzslcustomer_tblzslplatformbookingorder = new DSS3_LogisticsPoolingForUrbanDistribution.BO.tblZslCustomer
            {
                CustomerFullName = "tblZslCustomer_CustomerFullName",
            };
            var _zanardobo_tblzslbookingtype_tblzslplatformbookingorder = new DSS3_LogisticsPoolingForUrbanDistribution.BO.tblZslBookingType
            {
                BookingTypeName = "tblZslBookingType_BookingTypeName",
            };
            var _zanardobo_tblzsltransportorder_tblzslplatformbookingorder = new DSS3_LogisticsPoolingForUrbanDistribution.BO.tblZslTransportOrder
            {
            ...
            new PersistenceSpecification<DSS3_LogisticsPoolingForUrbanDistribution.BO.tblZslPlatformBookingOrder>(Session)
            ...
            .CheckProperty(p => p.PalletIN, 5763)
            .CheckProperty(p => p.TotalPallet, 981)
            ...
            .CheckProperty(p => p.RouteTracking_ID, 9347)
        ...
        public void tblZslPlatformBookingOrder_filtering_test()
        {
            ...
            List<DSS3_LogisticsPoolingForUrbanDistribution.BO.tblZslPlatformBookingOrder> results = null;
            Assert.DoesNotThrow(() =>
            {
                results = repo.GetAsQueryable<DSS3_LogisticsPoolingForUrbanDistribution.BO.tblZslPlatformBookingOrder>(
                              a => true
