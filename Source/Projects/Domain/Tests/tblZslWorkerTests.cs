...
namespace DSS3_LogisticsPoolingForUrbanDistribution.BoTesting.Tests
{
    ...
    internal class tblZslWorkerTests : NHibernateFixture
    {
        ...
        public void tblZslWorker_persistence_test()
        {
            ...
            var _zanardobo_worker_tblzslworker = new DSS3_LogisticsPoolingForUrbanDistribution.BO.tblZslWorker
            {
                WorkerFullName = "tblZslWorker_WorkerFullName",
            };
            new PersistenceSpecification<DSS3_LogisticsPoolingForUrbanDistribution.BO.tblZslWorker>(Session)
        ...
        public void tblZslWorker_filtering_test()
        {
            ...
            List<DSS3_LogisticsPoolingForUrbanDistribution.BO.tblZslWorker> results = null;
            Assert.DoesNotThrow(() =>
            {
                results = repo.GetAsQueryable<DSS3_LogisticsPoolingForUrbanDistribution.BO.tblZslWorker>(
                              a => true
