...
namespace DSS3_LogisticsPoolingForUrbanDistribution.BO
{
	...
	{
        public static int? Compare(this BO.CustomVolume @this, DSS3_LogisticsPoolingForUrbanDistribution.BO.CustomVolume Volume){using (new zAppDev.DotNet.Framework.Profiling.Profiler("CustomVolume", zAppDev.DotNet.Framework.Profiling.AppDevSymbolType.ClassOperation, "Compare")) {
int? compare = 0;
...
public static DSS3_LogisticsPoolingForUrbanDistribution.BO.CustomVolume CustomCopy(this BO.CustomVolume @this){using (new zAppDev.DotNet.Framework.Profiling.Profiler("CustomVolume", zAppDev.DotNet.Framework.Profiling.AppDevSymbolType.ClassOperation, "CustomCopy")) {
