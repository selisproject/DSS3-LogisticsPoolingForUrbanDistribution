...
namespace DSS3_LogisticsPoolingForUrbanDistribution.BO
{
    ...
    public class WorkflowSockWorkflow : WorkflowImplementation
    {
        ...
        public DSS3_LogisticsPoolingForUrbanDistribution.BO.WorkflowSockContext Context;
        #endregion
        public WorkflowSockWorkflow()
        {
            Context = new DSS3_LogisticsPoolingForUrbanDistribution.BO.WorkflowSockContext();
        ...
        {
            Context = state as DSS3_LogisticsPoolingForUrbanDistribution.BO.WorkflowSockContext;
        }
    }
    #endregion
    #region Steps
