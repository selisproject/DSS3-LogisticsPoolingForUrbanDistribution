...
namespace DSS3_LogisticsPoolingForUrbanDistribution.BO
{
	...
	{
        public static System.Collections.Generic.List<DSS3_LogisticsPoolingForUrbanDistribution.BO.PubMessage> InitPubMessage(System.Object obj){using (new zAppDev.DotNet.Framework.Profiling.Profiler("Utils", zAppDev.DotNet.Framework.Profiling.AppDevSymbolType.ClassOperation, "InitPubMessage")) {
...
public static void DesirializePubMessage(System.Collections.Generic.List<DSS3_LogisticsPoolingForUrbanDistribution.BO.PubMessage> message, string objectType){using (new zAppDev.DotNet.Framework.Profiling.Profiler("Utils", zAppDev.DotNet.Framework.Profiling.AppDevSymbolType.ClassOperation, "DesirializePubMessage")) {
...
public static DSS3_LogisticsPoolingForUrbanDistribution.BO.OrderWMS InitOrderWMS(System.Collections.Generic.List<DSS3_LogisticsPoolingForUrbanDistribution.BO.PubMessage> message){using (new zAppDev.DotNet.Framework.Profiling.Profiler("Utils", zAppDev.DotNet.Framework.Profiling.AppDevSymbolType.ClassOperation, "InitOrderWMS")) {
