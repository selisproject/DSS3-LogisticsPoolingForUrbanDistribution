...
namespace DSS3_LogisticsPoolingForUrbanDistribution.BLL.ExternalRestServices
{
    public class GoogleGeocodeRestService
    {
        ...
        public static DSS3_LogisticsPoolingForUrbanDistribution.ExternalStructs.GoogleGeocode.Root GeoLocation(string address)
        {
            ...
            Func<ServiceConsumptionContainer, DSS3_LogisticsPoolingForUrbanDistribution.ExternalStructs.GoogleGeocode.Root> _invocation = (_httpResponse) =>
            {
                var _returnedItem = RestServiceConsumer.Consume<DSS3_LogisticsPoolingForUrbanDistribution.ExternalStructs.GoogleGeocode.Root>(_options, _httpResponse);
                return zAppDev.DotNet.Framework.Utilities.Common.SafeCast<DSS3_LogisticsPoolingForUrbanDistribution.ExternalStructs.GoogleGeocode.Root>(_returnedItem);
            };
            var _consumer = new ServiceConsumer<DSS3_LogisticsPoolingForUrbanDistribution.ExternalStructs.GoogleGeocode.Root>(_invocation);
