...
namespace DSS3_LogisticsPoolingForUrbanDistribution.Locales
{
    ...
    public class LocaleResolver
    {
        ...
        private static string ReadEmbededResource(string fullPath)
        {
            ...
            var stream = typeof(DSS3_LogisticsPoolingForUrbanDistribution.Locales.LocaleResolver).Assembly.GetManifestResourceStream(fullPath);
            if (stream == null)
            {
                stream = typeof(DSS3_LogisticsPoolingForUrbanDistribution.Locales.LocaleResolver).Assembly.GetManifestResourceStream("Locales." + fullPath);
            }
            if(stream == null)
            {
                stream = typeof(DSS3_LogisticsPoolingForUrbanDistribution.Locales.LocaleResolver).Assembly.GetManifestResourceStream("DSS3_LogisticsPoolingForUrbanDistribution."+ "Locales." + fullPath);
            }
            if(stream == null)
            {
                stream = typeof(DSS3_LogisticsPoolingForUrbanDistribution.Locales.LocaleResolver).Assembly.GetManifestResourceStream("DSS3_LogisticsPoolingForUrbanDistribution."+ "Locales.Locales." + fullPath);
            }
            if(stream == null)
            {
                stream = typeof(DSS3_LogisticsPoolingForUrbanDistribution.Locales.LocaleResolver).Assembly.GetManifestResourceStream("DSS3_LogisticsPoolingForUrbanDistribution.Backend."+ "Locales.Locales." + fullPath);
            }
