...
namespace DSS3_LogisticsPoolingForUrbanDistribution.BO
{
    ...
    [Serializable]
    [DataContract]
    public class Volume : IDomainModelClass
    {
        #region Volume's Fields
...
///
        ...
        #endregion
        #region Volume's Participant Properties
        ...
        #region Constructors
/// <summary>
/// Public constructors of the Volume class
/// </summary>
/// <returns>New Volume object</returns>
/// <remarks></remarks>
        public Volume() {}
        #endregion
        #region Methods
        ...
        public virtual List<string> _Validate(bool throwException = true)
        {
            ...
            {
                throw new zAppDev.DotNet.Framework.Exceptions.BusinessException("An instance of TypeClass 'Volume' has validation errors:\r\n\r\n" + string.Join("\r\n", __errors));
            }
            return __errors;
        }
...
/// <param name="copy">Optional - An existing [Volume] instance to use as the destination.</param>
/// <returns>A copy of the object</returns>
        public virtual Volume Copy(bool deep=false, Hashtable copiedObjects=null, bool asNew=false, bool reuseNestedObjects = false, Volume copy = null)
        {
            ...
            if (copy == null && copiedObjects.Contains(this))
                return (Volume)copiedObjects[this];
            copy = copy ?? new Volume();
            if (!asNew)
            {
...
/// </summary>
        protected bool HasSameNonDefaultIdAs(Volume compareTo)
        {
