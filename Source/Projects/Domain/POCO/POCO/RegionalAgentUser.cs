...
namespace DSS3_LogisticsPoolingForUrbanDistribution.BO
{
    ...
    public class RegionalAgentUser : ApplicationUser, IDomainModelClass
    {
        #region RegionalAgentUser's Fields
        #endregion
        #region RegionalAgentUser's Participant Properties
        ...
        public virtual RegionalAgent RegionalAgent
        {
            ...
            set
            {
                ...
                regionalAgent?.InternalRemoveRAUsers(this);
                regionalAgent = value;
                if (value != null)
                {
                    regionalAgent.InternalAddRAUsers(this);
                }
            }
        }
        #endregion
        #region Constructors
/// <summary>
/// Public constructors of the RegionalAgentUser class
/// </summary>
/// <returns>New RegionalAgentUser object</returns>
/// <remarks></remarks>
        public RegionalAgentUser(): base() {}
        #endregion
        #region Methods
        ...
        public override List<string> _Validate(bool throwException = true)
        {
            ...
            {
                throw new zAppDev.DotNet.Framework.Exceptions.BusinessException("An instance of TypeClass 'RegionalAgentUser' has validation errors:\r\n\r\n" + string.Join("\r\n", __errors));
            }
            return __errors;
        }
...
/// <param name="copy">Optional - An existing [RegionalAgentUser] instance to use as the destination.</param>
/// <returns>A copy of the object</returns>
        public virtual RegionalAgentUser Copy(bool deep=false, Hashtable copiedObjects=null, bool asNew=false, bool reuseNestedObjects = false, RegionalAgentUser copy = null)
        {
            ...
            if (copy == null && copiedObjects.Contains(this))
                return (RegionalAgentUser)copiedObjects[this];
            copy = copy ?? new RegionalAgentUser();
            if (!asNew)
            {
        ...
        {
            var compareTo = obj as RegionalAgentUser;
...
// Maintain equality operator semantics for entities.
        public static bool operator ==(RegionalAgentUser x, RegionalAgentUser y)
        {
