...
namespace DSS3_LogisticsPoolingForUrbanDistribution.BO
{
    ...
    public class WorkContract : IDomainModelClass
    {
        ...
        protected DSS3_LogisticsPoolingForUrbanDistribution.BO.ContractStatus? status;
...
/// </summary>
///
        public virtual DSS3_LogisticsPoolingForUrbanDistribution.BO.ContractStatus? Status
        {
            get
            {
                return status;
