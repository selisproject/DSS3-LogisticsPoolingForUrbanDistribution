...
namespace DSS3_LogisticsPoolingForUrbanDistribution.ExternalStructs.GoogleDistanceMatrixAPI
{
    ...
    public class GoogleDistanceMatrixAPIRoot
    {
        ...
        public DSS3_LogisticsPoolingForUrbanDistribution.ExternalStructs.GoogleDistanceMatrixAPI.rows[] rows
        {
            get;
            set;
        }
    ...
    public class rows
    {
        ...
        public DSS3_LogisticsPoolingForUrbanDistribution.ExternalStructs.GoogleDistanceMatrixAPI.elements[] elements
        {
            get;
            set;
        }
    ...
    public class elements
    {
        ...
        public DSS3_LogisticsPoolingForUrbanDistribution.ExternalStructs.GoogleDistanceMatrixAPI.distance distance
        {
            get;
            set;
        }
        ...
        public DSS3_LogisticsPoolingForUrbanDistribution.ExternalStructs.GoogleDistanceMatrixAPI.duration duration
        {
            get;
            set;
        }
