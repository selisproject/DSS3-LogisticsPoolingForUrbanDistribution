...
namespace DSS3_LogisticsPoolingForUrbanDistribution.ExternalStructs.GoogleGeocode
{
    [XmlRoot("Root")]
    public class Root
    {
        ...
        public DSS3_LogisticsPoolingForUrbanDistribution.ExternalStructs.GoogleGeocode.result[] results
        {
            get;
            set;
        }
    ...
    public class result
    {
        ...
        public DSS3_LogisticsPoolingForUrbanDistribution.ExternalStructs.GoogleGeocode.address_component[] address_components
        {
            get;
            set;
        }
        ...
        public DSS3_LogisticsPoolingForUrbanDistribution.ExternalStructs.GoogleGeocode.geometry geometry
        {
            get;
            set;
        }
    ...
    public class geometry
    {
        ...
        public DSS3_LogisticsPoolingForUrbanDistribution.ExternalStructs.GoogleGeocode.location location
        {
            get;
            set;
        }
        ...
        public DSS3_LogisticsPoolingForUrbanDistribution.ExternalStructs.GoogleGeocode.viewport viewport
        {
            get;
            set;
        }
        ...
        public DSS3_LogisticsPoolingForUrbanDistribution.ExternalStructs.GoogleGeocode.viewport bounds
        {
            get;
            set;
        }
    ...
    public class viewport
    {
        ...
        public DSS3_LogisticsPoolingForUrbanDistribution.ExternalStructs.GoogleGeocode.location northeast
        {
            get;
            set;
        }
        ...
        public DSS3_LogisticsPoolingForUrbanDistribution.ExternalStructs.GoogleGeocode.location southwest
        {
            get;
            set;
        }
