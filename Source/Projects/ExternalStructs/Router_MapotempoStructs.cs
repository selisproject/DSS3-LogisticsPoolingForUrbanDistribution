...
namespace DSS3_LogisticsPoolingForUrbanDistribution.ExternalStructs.Router_Mapotempo
{
    ...
    public class Router_MapotempoRoot
    {
        ...
        public DSS3_LogisticsPoolingForUrbanDistribution.ExternalStructs.Router_Mapotempo.router router
        {
            get;
            set;
        }
        ...
        public DSS3_LogisticsPoolingForUrbanDistribution.ExternalStructs.Router_Mapotempo.features[] features
        {
            get;
            set;
        }
    ...
    public class features
    {
        ...
        public DSS3_LogisticsPoolingForUrbanDistribution.ExternalStructs.Router_Mapotempo.properties properties
        {
            get;
            set;
        }
        ...
        public DSS3_LogisticsPoolingForUrbanDistribution.ExternalStructs.Router_Mapotempo.geometry geometry
        {
            get;
            set;
        }
    ...
    public class properties
    {
        [XmlElement("router")]
        [Newtonsoft.Json.JsonProperty("router")]
        public DSS3_LogisticsPoolingForUrbanDistribution.ExternalStructs.Router_Mapotempo.propertiesRouter router
        {
            get;
            set;
        }
