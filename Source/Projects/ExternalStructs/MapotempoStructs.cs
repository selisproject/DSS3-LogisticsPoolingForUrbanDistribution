...
namespace DSS3_LogisticsPoolingForUrbanDistribution.ExternalStructs.Mapotempo
{
    ...
    public class MapotempoRoot
    {
        ...
        public DSS3_LogisticsPoolingForUrbanDistribution.ExternalStructs.Mapotempo.geocoding geocoding
        {
            get;
            set;
        }
        ...
        public DSS3_LogisticsPoolingForUrbanDistribution.ExternalStructs.Mapotempo.features[] features
        {
            get;
            set;
        }
    ...
    public class features
    {
        ...
        public DSS3_LogisticsPoolingForUrbanDistribution.ExternalStructs.Mapotempo.properties properties
        {
            get;
            set;
        }
        ...
        public DSS3_LogisticsPoolingForUrbanDistribution.ExternalStructs.Mapotempo.geometry geometry
        {
            get;
            set;
        }
    ...
    public class properties
    {
        [XmlElement("geocoding")]
        [Newtonsoft.Json.JsonProperty("geocoding")]
        public DSS3_LogisticsPoolingForUrbanDistribution.ExternalStructs.Mapotempo.propertiesGeocoding geocoding
        {
            get;
            set;
        }
