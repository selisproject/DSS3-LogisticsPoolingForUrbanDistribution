...
namespace DSS3_LogisticsPoolingForUrbanDistribution.ExternalStructs.LocalPubSub
{
    ...
    public class SubRoot
    {
        ...
        public DSS3_LogisticsPoolingForUrbanDistribution.ExternalStructs.LocalPubSub.SubRule[] data
        {
            get;
            set;
        }
    ...
    public class Publication
    {
        ...
        public DSS3_LogisticsPoolingForUrbanDistribution.ExternalStructs.LocalPubSub.PubMessage[] publication
        {
            get;
            set;
        }
